...
public class TestAPI extends Application {
    ...
    public TestAPI() {
        ...
        teachers.add(new Teacher(users.get(2).getId(), users.get(3).getEmail(), users.get(3).getFirstName(), users.get(3).getLastName(), users.get(3).getUserType(), users.get(3).getDateJoined(), "MCB"));
        teachers.add(new Teacher(users.get(4).getId(), users.get(4).getEmail(), users.get(4).getFirstName(), users.get(4).getLastName(), users.get(4).getUserType(), users.get(4).getDateJoined(), "MCB"));
        ...
        students.add(new Student(users.get(2).getId(), users.get(2).getEmail(), users.get(2).getFirstName(), users.get(2).getLastName(), users.get(2).getUserType(), users.get(2).getDateJoined(), "181831033883", sections.get(0)));

        assignments = new ArrayList<>();
        assignments.add(new Assignment(1, sections.get(0), teachers.get(0), modules.get(0), Utils.TD, Arrays.asList(1, 2)));
        assignments.add(new Assignment(2, sections.get(2), teachers.get(2), modules.get(2), Utils.TP, Collections.singletonList(3)));
        assignments.add(new Assignment(3, sections.get(3), teachers.get(3), modules.get(3), Utils.COURS, Arrays.asList(1, 2, 3)));
        ...
        sessions.add(new Session(2, assignments.get(2), Collections.singletonList(3), "08:00", "09:30", "https://facultydz.webex.com/facultydz/j.php?MTID=m275c959d1786501ca18107725f7f883d", "957 867 485", "mfgUdkOp"));
        sessions.add(new Session(3, assignments.get(3), Arrays.asList(1, 2, 3), "08:00", "09:30", "https://facultydz.webex.com/facultydz/j.php?MTID=m275c959d1786501ca18107725f7f883d", "957 867 485", "mfgUdkOp"));
        ...
        homework.add(new Homework(2, assignments.get(2), Collections.singletonList(3), "Serie 3, Exercice 1", new Date(2021, 4, 25), "Faites le deuxième exercice de la première série, ne faites pas la dernière question car nous le ferons dans le cours."));
        homework.add(new Homework(3, assignments.get(3), Arrays.asList(1, 2, 3), "Serie 2, Exercice 4", new Date(2021, 5, 10), "Faites le deuxième exercice de la première série, ne faites pas la dernière question car nous le ferons dans le cours."));
    }
